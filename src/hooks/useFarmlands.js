...
const mapFromSupabase = (item) => ({
  ...
  cadastralCoverageGeometry: item.cadastral_coverage_geometry || null,
  geometryStatus: item.geometry_status || "defined",
...
const mapToSupabase = (item, userId) => ({
  ...
  coordinates: item.coordinates,
  geometry: item.geometry || null,
  cadastral_coverage_geometry: item.cadastralCoverageGeometry || null,
  geometry_status: item.geometryStatus || "defined",
  company_id: item.company_id || null,
  owner_id: userId,
