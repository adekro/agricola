                ...
                <div className={classes.layoutContentItem}>
                    <form onSubmit={formik.handleSubmit} className={classes.form} >
                        <TextField
                            ...
                            fullWidth
                            label="Name"
                            id="name" name="name" onChange={formik.handleChange}
                        ...
                        <TextField
                            fullWidth
                            label="Phone" type="tel" name="phone" onChange={formik.handleChange}
                            value={formik.values.phone} />


                        <TextField
                            fullWidth
                            label="Website" type="text" name="website" onChange={formik.handleChange}
                            value={formik.values.website} />


                        <TextField
                            fullWidth
                            label="Notes" type="text" name="notes" onChange={formik.handleChange}
