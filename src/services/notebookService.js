...
export const notebookService = {
  ...
  async getOperations(filters = {}) {
    let query = supabase
      .from("operations")
      .select("*, farmland:farmland_id(id, type, area, company_id, owner_display_name, current_crop), product:product_id(id, name, category, company_id), batch:inventory_batch_id(id, batch_number, expiry_date), company:company_id(id, name)")
